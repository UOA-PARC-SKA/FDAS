...
channel uint  detect_location_out[${hms_n_planes}][${hms_group_sz * hms_bundle_sz}] ${depth_attr};
channel float detect_amplitude_out[${hms_n_planes}][${hms_group_sz * hms_bundle_sz}] ${depth_attr};
