...
namespace HMS {
    ...
    static const cl_uint  group_sz                  = 12;
    static const cl_uint  bundle_sz                 = 1;
    static const cl_uint  slot_sz                   = 16;

    static const     cl_uint lcm = 840;
    static constexpr cl_uint n_buffers[8] = {12, 6, 4, 3, 4, 2, 3, 2};
    static constexpr cl_uint first_cc_to_use_last_buffer[8] = {0, 0, 0, 0, 4, 0, 3, 0};
