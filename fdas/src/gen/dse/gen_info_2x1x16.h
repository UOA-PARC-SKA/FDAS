...
namespace FFT {
    ...
    static const cl_uint  n_engines                 = 2;
}
namespace FTC {
...
namespace HMS {
    ...
    static const cl_uint  group_sz                  = 1;
    static const cl_uint  bundle_sz                 = 16;
    static const cl_uint  slot_sz                   = 16;

    static const cl_uint  unroll_x                  = 1;

    static const     cl_uint lcm = 840;
    static constexpr cl_uint n_buffers[8] = {1, 1, 1, 1, 1, 1, 1, 1};
    static constexpr cl_uint first_cc_to_use_last_buffer[8] = {0, 0, 0, 0, 0, 0, 0, 0};
