...
channel float4 preload_to_delay[8][2] __attribute__((depth(0)));
channel float4 delay_to_detect[8][2] __attribute__((depth(0)));

channel float4 detect_to_detect[7][2] __attribute__((depth(0)));
