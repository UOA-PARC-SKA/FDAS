...
namespace HMS {
    ...
    static const cl_uint  group_sz                  = 16;
    ...
    static constexpr cl_uint n_buffers[8] = {16, 8, 6, 4, 4, 4, 4, 2};
    static constexpr cl_uint first_cc_to_use_last_buffer[8] = {0, 0, 0, 0, 0, 4, 6, 0};
