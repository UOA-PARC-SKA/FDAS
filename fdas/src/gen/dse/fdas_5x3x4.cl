...
channel float4 preload_to_delay[8][3] __attribute__((depth(0)));
channel float4 delay_to_detect[8][3] __attribute__((depth(0)));

channel float4 detect_to_detect[7][3] __attribute__((depth(0)));
                      ...
                      )
{
    ...
    for (uint bundle = 0; bundle < n_bundles; ++bundle) {
        ...
        out[0] = load[0];
        out[1] = cc_of_group_base < 1 ? load[0] : load[1];
        out[2] = load[1];
                      ...
                      )
{
    ...
    for (uint bundle = 0; bundle < n_bundles; ++bundle) {
        ...
        out[0] = load[0];
        out[1] = cc_of_group_base < 3 ? load[0] : load[1];
        out[2] = cc_of_group_base < 2 ? load[0] : load[1];
                      ...
                      )
{
    ...
    for (uint bundle = 0; bundle < n_bundles; ++bundle) {
        ...
        out[0] = load[0];
        out[1] = cc_of_group_base < 7 ? load[0] : load[1];
        out[2] = cc_of_group_base < 6 ? load[0] : load[1];
                     ...
                     uint n_bundles)
{
    ...
    for (uint group = 0; group < n_groups; ++group) {
        ...
        for (uint bundle = 0; bundle < n_bundles; ++bundle) {
            ...
            bool any_cand = cand[0] | cand[1] | cand[2] | cand[3] | cand[4] | cand[5] | cand[6] | cand[7] | cand[8] | cand[9] | cand[10] | cand[11];
            if (any_cand) {
                uint loc[16];
                float pwr[16];
                ...
                loc[12] = invalid_location;
                pwr[12] = invalid_power;
                loc[13] = invalid_location;
                pwr[13] = invalid_power;
                loc[14] = invalid_location;
                pwr[14] = invalid_power;
                loc[15] = invalid_location;
                pwr[15] = invalid_power;
