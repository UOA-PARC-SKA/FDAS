...
channel float8 preload_to_delay[8][1] __attribute__((depth(0)));
channel float8 delay_to_detect[8][1] __attribute__((depth(0)));

channel float8 detect_to_detect[7][1] __attribute__((depth(0)));
